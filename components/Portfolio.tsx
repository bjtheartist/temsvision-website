        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-12">
          ...
          <div className="max-w-md text-right">
            ...
            <button className="mt-10 flex items-center gap-4 text-xs font-black tracking-widest ml-auto group uppercase">
              ALL PROJECTS
              <span className="w-12 h-12 rounded-full bg-white text-black flex items-center justify-center transition-all group-hover:bg-zinc-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {PROJECTS.map((project) => (
            <div key={project.id} className="project-card group cursor-pointer">
              ...
              <h3 className="text-3xl font-black tracking-tighter mb-4 uppercase group-hover:text-zinc-400 transition-colors">{project.title}</h3>
